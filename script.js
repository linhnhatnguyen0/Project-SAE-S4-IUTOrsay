...
const infermerie = new Marker("infermerie",2.170345958742877, 48.711066855872076, renseignement, "Hello world"  );
infermerie.addMarqueur();

const salleLS2 = new Marker("salle libre service",2.170856965747116,48.711191295370924, espaceTravail, "Hello world"  );
salleLS2.addMarqueur();

const mediathequeI = new Marker("Médiathèque IUT",2.1709786340814596,48.71126756458912, espaceTravail, "Hello world"  );
mediathequeI.addMarqueur();

const toilette4 = new Marker("Toilettes IUT",2.1707626727880007,48.711285628334366, toilettes, "Hello world"  );
toilette4.addMarqueur();

const toilette5 = new Marker("Toilettes IUT",2.1706866300790364,48.71117323159183, toilettes, "Hello world"  );
toilette5.addMarqueur();

const toilette6 = new Marker("Toilettes IUT",2.1714208363723126,48.71081819195018, toilettes, "Hello world"  );
toilette6.addMarqueur();

const secriteriat = new Marker("secriteriat",2.1714765096606183,48.71108519113125, renseignement, "Hello world"  );
secriteriat.addMarqueur();

const salleLS3 = new Marker("salle I118",2.1714994690407976,48.71113190327591, espaceTravail, "libre service + imprimante"  );
salleLS3.addMarqueur();

const salleLS4 = new Marker("salle I120",2.1714975557591156,48.71107509120236, espaceTravail, "libre service + imprimante"  );
salleLS4.addMarqueur();
